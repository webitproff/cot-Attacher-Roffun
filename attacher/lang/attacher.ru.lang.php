...
$L['info_note'] = '<a href="https://abuyfile.com/ru/forums/cotonti/custom/plugs/attacher" title="Attacher раздел помощи.">Раздел помощи.</a> Если что-то не получается, не теряйте время, лучше задайте вопрос в этом разделе форума';
