    ...
    <div class="col-xs-12 fileupload" id="fileupload_{ATTACHER_AREA}_{ATTACHER_ITEM}_{ATTACHER_FIELD}" data-url="{ATTACHER_ACTION}">
        ...
        <div class="fileupload-buttonbar">
			...
			<div class="mb-3 row col-12">
				<label class="form-label fw-semibold">{PHP.L.att_url_placeholder}</label>
				<div class="url-upload">
					<div class="row mb-2">
						<div class="col-12">
							<input type="text" id="attacher_url_{ATTACHER_ID}" name="attacher_url" class="form-control">
						</div>
						<div class="col-12">
							<button type="button" class="mt-3 btn btn-outline-primary attacher-url-upload" data-form-id="{ATTACHER_ID}">{PHP.L.att_upload_url}</button>
						</div>
					</div>
				</div>
			</div>
