...
function att_cot_thumb($source, $target, $width, $height, $resize = 'crop', $quality = 85, $upscale = false)
{
    ...
    if ($oldimage === false) {
        // $newimage будет автоматически уничтожен при выходе из функции, вызов imagedestroy не нужен
        return false;
    }
    ...
    // Оба ресурса ($newimage и $oldimage) будут освобождены автоматически
    return true;
}
